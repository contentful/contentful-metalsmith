  ...
  return function(files, metalsmith, done){
    ...
    function processFile(file, fileProcessedCallback){
      ...
      query  = _.extend({},
          ...
          (fileMetadata.contentful.limit ? {limit : fileMetadata.contentful.limit} : undefined),
          (fileMetadata.contentful.order ? {order : fileMetadata.contentful.order} : undefined)
          );
